...
import type { AppointmentDto, AppointmentFiltersDto } from '@packages/shared-types';
 ...
 */
function convertFiltersToApi(filters?: AppointmentFilters): AppointmentFiltersDto | undefined {
...
const appointmentsApi = {
   ...
   */
  getAll: async (filters?: AppointmentFilters): Promise<AppointmentReadModel[]> => {
