...
**Naming conventions and file structure for the project**
...
> - [32-eslint-configuration.md](./32-eslint-configuration.md) - ESLint path aliases
...
├── conversation/
│   └── conversation.module.ts   # ✅ Correcto - convención del framework
└── auth/
