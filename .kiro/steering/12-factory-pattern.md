---
inclusion: fileMatch
fileMatchPattern: "**/infra/persistence/factories/**/*.ts,**/domain/interfaces/factories/**/*.ts"
---

# Factory Pattern para CQRS Estricto

**Factory pattern for loading aggregates while maintaining strict CQRS separation**

> **Cross-References:**
>
> - [10-cqrs-pattern.md](./10-cqrs-pattern.md) - CQRS implementation context
> - [11-ddd-tactical-patterns.md](./11-ddd-tactical-patterns.md) - DDD patterns overview
> - [04-system-architecture.md](./04-system-architecture.md) - Architectural principles
