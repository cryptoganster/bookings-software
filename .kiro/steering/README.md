...
- `60-git-workflow.md` - Git workflow with rebase strategy
- `66-prohibited-commands.md` - AI agent safety rules (CRITICAL)

### FileMatch Inclusion (12 files)
...
**Total Files:** 20  
**Status:** Complete ✅ (Git Workflow Refactored)
...
- **Always (6 files):** Core principles loaded for every interaction
- **FileMatch (12 files):** Context-specific guidance loaded when working with matching files
